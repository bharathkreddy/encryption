...
+ [AES : Advanced Encryption Standard](https://github.com/bharathkreddy/encryption/blob/main/Encryption%20algorithms/AES.md) Current De facto standard. Key lengths 126, 192 and 256. 
+ [chacha20](): Closest to AES, light weight. 
...
### 2.1 [Asymmetric key encryption using GnuPg](link)

### 2.2 [Asymmetric key encryption using OpenSSL](link)
